...
def main():
    ...
    # FILL HERE
    data_path_t1 = r'E:\Yuli\Projects\overian_classification\overian_classification\dataset\JHH_Penn_Taiwan_dataset\UPenn\T1-ROI-preprocess' #FILL HERE
    data_path_t2 = r'E:\Yuli\Projects\overian_classification\overian_classification\dataset\JHH_Penn_Taiwan_dataset\UPenn\T2-ROI-preprocess' #FILL HERE
    xx = pd.read_excel(r'E:\Yuli\Projects\overian_classification\overian_classification\dataset\JHH_Penn_Taiwan_dataset\UPenn\label-classificationT1C+T2-clear.xlsx', sheet_name='Sheet1') #FILL HERE
    # END FILL
    ...
    clinic = xx.iloc[:, 21:28]  # all clinic data
