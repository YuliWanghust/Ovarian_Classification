...
###========transform for finding complementary features
        self.cc_t1_1=CCAModel(inchannels_cc=256*2)
        self.cc_t1_2 = CCAModel(inchannels_cc=512*2)
        self.cc_t1_3 = CCAModel(inchannels_cc=1024*2)
        self.cc_t1_4 = CCAModel(inchannels_cc=1024*2)
    ...
    def forward(self, x_t1: torch.Tensor, x_t2:torch.Tensor, x_cli:torch.Tensor) -> torch.Tensor:
        ...
        #complementary1
        x_fuse = torch.cat([x_t1, x_t2], dim=1)
        x_fuse = self.cc_t1_1(x_fuse, x_fuse, 3)
        x_fuse = self.t1_1c(x_fuse)
        x_t1 = x_fuse+x_t1
        x_t2 = x_fuse+x_t2
        ...
        #complementary2
        x_fuse = torch.cat([x_t1, x_t2], dim=1)
        x_fuse = self.cc_t1_2(x_fuse, x_fuse, 3)
        x_fuse = self.t1_2c(x_fuse)
        x_t1 = x_fuse + x_t1
        x_t2 = x_fuse + x_t2
        ...
        #complementary3
        x_fuse = torch.cat([x_t1, x_t2], dim=1)
        x_fuse = self.cc_t1_3(x_fuse, x_fuse, 3)
        x_fuse = self.t1_3c(x_fuse)
        x_t1 = x_fuse + x_t1
        x_t2 = x_fuse + x_t2
        ...
        # complementary4
        x_fuse = torch.cat([x_t1, x_t2], dim=1)
        x_fuse = self.cc_t1_4(x_fuse, x_fuse, 3)
        x_fuse = self.t1_4c(x_fuse)
        x_t1 = x_fuse + x_t1
        x_t2 = x_fuse + x_t2
