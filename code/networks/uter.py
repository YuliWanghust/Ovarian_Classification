...
class UNETR(nn.Module):
    ...
    def forward(self, x_in):  #x_in[4,1,96,96,96]
        x, hidden_states_out = self.vit(x_in) #x[4,216,768]  hidden_states_out 是list 0-11个tensor
        enc1 = self.encoder1(x_in) #[4,16,96,96,96]
        ...
        dec4 = self.proj_feat(x, self.hidden_size, self.feat_size) #[4,768,6,6,6]
        dec3 = self.decoder5(dec4, enc4) #[4,128,12,12,12]
        dec2 = self.decoder4(dec3, enc3) #[4,768,6,6,6]
