...
def main():
    ...
    # FILL HERE
    data_path_t1 = r'E:\Yuli\Projects\overian_classification\overian_classification\dataset\JHH_Penn_Taiwan_dataset\JHH_nii\T1-ROI-preprocess' #FILL HERE
    data_path_t2 = r'E:\Yuli\Projects\overian_classification\overian_classification\dataset\JHH_Penn_Taiwan_dataset\JHH_nii\T2-ROI-preprocess' #FILL HERE
    xx = pd.read_excel(r'E:\Yuli\Projects\overian_classification\overian_classification\dataset\JHH_Penn_Taiwan_dataset\JHH_nii\label-classifyT1C+T2-clear.xlsx', sheet_name='Sheet1') #FILL HERE
    # END FILL
